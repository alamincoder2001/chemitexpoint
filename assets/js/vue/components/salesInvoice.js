        ...
        async print(){
            ...
            if (this.currentBranch.print_type == '3') {
                ...
                printWindow.document.write(`
                    ...
                    <body>
                        <div class="row">
                            <div class="col-xs-3" style="padding-right: 0"><img src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_org}" alt="Logo" style="height:100px;" /></div>
                        ...
                        <div style="position:fixed;left:0;bottom:5px; width:500px;">
