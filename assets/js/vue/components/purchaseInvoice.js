            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        ...
                        <strong>Company Name:</strong> {{ purchase.Supplier_Name }}<br>
                        <strong>Supplier Name:</strong> {{ purchase.contact_person }}<br>
                    ...
                    <strong>Purchase Date:</strong> {{ purchase.PurchaseMaster_OrderDate }} {{ moment(purchase.AddTime).format('h:mm a') }}<br>
                        <strong>Purchase by:</strong> {{ purchase.AddBy }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                    ...
                    <div class="col-xs-6">
                        ...
                        <table class="pull-left">
                            ...
                            <tr>
                                ...
                                <td style="text-align:right; color:red !important;">{{ (parseFloat(purchase.previous_due) + parseFloat(purchase.PurchaseMaster_DueAmount == null ? 0.00 : purchase.PurchaseMaster_DueAmount)).toFixed(2) }}</td>
                            </tr>
                        </table>
                        <table style="clear:both; float:left;margin-top:15px;">
                            <tr>
                                <th>In Word: </th>
                                <td style="padding-left: 10px;"> {{ convertNumberToWords(purchase.PurchaseMaster_TotalAmount) }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right; color:green !important;">{{ purchase.PurchaseMaster_PaidAmount }}</td>
                            </tr>
                            <tr><td colspan="2" style="border-bottom: 1px solid #000"></td></tr>
                            <tr>
                                <td><strong>Due:</strong></td>
                                <td style="text-align:right; color:red !important;">{{ purchase.PurchaseMaster_DueAmount }}</td>
                            </tr>
                        </table>
            ...
            printWindow.document.write(`
                ...
                <body>
                    ...
                    <div class="container" style="position:fixed;bottom:15px;width:100%;">
                        <div class="row" style="border-bottom:1px solid #000;margin-bottom:5px;padding-bottom:6px;">
                            <div class="col-xs-6">
