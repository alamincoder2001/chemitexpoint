...
<div id="salesRecord">
	...
	<div class="row" style="margin-top:15px;display:none;" v-bind:style="{display: sales.length > 0 ? '' : 'none'}">
		<div class="col-md-12" style="margin-bottom: 10px;">
			<a class="btn btn-xs btn-primary" href="" @click.prevent="print"><i class="fa fa-print"></i> Print</a>
		</div>
		<div class="col-md-12">
					...
					<tbody>
						<template v-for="sale in sales">
							...
							<tr v-for="(product, sl) in sale.saleDetails.slice(1)">
								<td colspan="4" v-bind:rowspan="sale.saleDetails.length - 1" v-if="sl == 0"></td>
							...
							<tr style="font-weight:bold;">
								...
								<td style="text-align:right;">
									...
									<span style="color: green !important ;">Paid: {{ sale.SaleMaster_PaidAmount }}</span><br>
									<span style="">Due: {{ sale.SaleMaster_DueAmount }}</span>
								</td>
								<td></td>
							</tr>
						</template>
				...
				<table 
					...
					<tbody>
						<tr v-for="sale in sales">
							...
							<td style="text-align:right;" :style="{color: sale.SaleMaster_PaidAmount != 0 ? 'green !important' : ''}">{{ sale.SaleMaster_PaidAmount }}</td>
					...
					<tfoot>
						<tr style="font-weight:bold;">
							...
							<td style="text-align:right;color:green !important;">{{ sales.reduce((prev, curr)=>{return prev + parseFloat(curr.SaleMaster_PaidAmount)}, 0) }}</td>
							<td style="text-align:right;color:red !important;">{{ sales.reduce((prev, curr)=>{return prev + parseFloat(curr.SaleMaster_DueAmount)}, 0) }}</td>
							<td></td>
							<td></td>
						</tr>
					</tfoot>
			...
			async print(){
				...
				let reportContent = `
					<div class="container">
						...
						<div style="margin-top: 50px; bottom:5px;width:100%;">
							<div class="row" style="font-size:12px;">
								<div class="col-xs-3" style="margin-bottom: 10px; margin-left: 30px;">
								...
								<div class="col-xs-3" style="float: right; margin-right: 30px;">
									<div style="border-top: 1px solid #000; text-align: center;">
