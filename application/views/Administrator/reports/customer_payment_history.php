                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr v-for="payment in payments">
							...
							<td style="text-align:right; font-weight: 700;">{{ payment.CPayment_amount }}</td>
                        </tr>
                    </tbody>
                    <tfoot v-if="paymentType != ''">
                        <tr>
                            <td colspan="6" style="text-align:right;font-weight: 700;">Total</td>
                            <td style="text-align:right;font-weight: 700;">{{ payments.reduce((p, c) => { return p + parseFloat(c.CPayment_amount)}, 0).toFixed(2) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
