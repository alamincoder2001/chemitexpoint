...
<a href="<?php echo base_url();?>customerPaymentPage" title="" class="buttonAshiqe">Go Back</a>
    <div id="reportContent">
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
                <h6 style="background:#ddd; text-align: center; font-size: 18px; font-weight: 900; padding: 5px; color: red !important;">Customer Payment</h6>
            </div>
        </div>
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-6">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td colspan="2" style="font-size: 13px; font-weight: 600;color:green  !important;"><?php echo $CPROW->owner_name; ?></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="font-size: 13px; font-weight: 600; ">Customer Name :</td>
                        <td colspan="2" style="font-size: 13px; font-weight: 600;color:green  !important;"><?php echo $CPROW->Customer_Name; ?></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="font-size: 13px; font-weight: 600; ">Phone Number:</td>
                        <td colspan="2" style="font-size: 13px; font-weight: 600;color:green  !important;"><?php echo $CPROW->Customer_Mobile; ?></td>
                    </tr>
                </table>
            </div>
            <div class="col-xs-6">
                <table style="width: 100%;text-align:right;">
                    <tr>
                        ...
                        <td style="font-size: 13px; font-weight: 600;color:green !important;"><?php echo $CPROW->CPayment_invoice; ?></td>
                    </tr>
                    <tr>
                        <td style="font-size: 13px; font-weight: 600; ">TR. Date:</td>
                        <td style="font-size: 13px; font-weight: 600;color:green  !important;"><?php echo $CPROW->CPayment_date; ?> </td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="col-xs-12">
                <table class="border" cellspacing="0" cellpadding="0" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <td style="color:green !important;"><?php echo $CPROW->CPayment_notes; ?></td>
                        <td style="text-align:right;color:green !important;"><?php if($type == 'CR'): echo number_format($CPROW->CPayment_amount, 2); else: echo '00.00'; endif; ?></td>
                        <td style="text-align:right;color:green !important;"><?php if($type == 'CP'): echo number_format($CPROW->CPayment_amount, 2); else: echo '00.00'; endif; ?></td>
                        </tr>
                        <tr>
                            <th colspan="2" style="font-size: 14px; font-weight: 700; text-align: right;">Total:</th>
                            <th style="font-size: 13px; font-weight: 700;text-align:right;color:green !important;"><?php if($type == 'CR'): echo number_format($CPROW->CPayment_amount, 2); else: echo '00.00'; endif; ?></th>
                            <th style="font-size: 13px; font-weight: 700;text-align:right;color:green !important;"><?php if($type == 'CP'): echo number_format($CPROW->CPayment_amount, 2); else: echo '00.00'; endif; ?></th>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-8">
                <h6 style=" font-size: 10px; font-weight: 600; ">Paid (In Word): <span style="color:green !important;"><?php echo convertNumberToWord($CPROW->CPayment_amount);?></span> </h6>
            </div>
            <div class="col-xs-4 text-left;">
                <table style="width: 100%;float:right;">
                    <tr>
                        <td  style="font-size: 13px; font-weight: 600; ">Previous Due : </td>
                        <td  style="font-size: 13px; font-weight: 600; text-align: right;color:red !important;"> <?php echo number_format($prevdueAmont, 2); ?></td>
                    </tr>
                    <tr>
                        <td  style="font-size: 13px; font-weight: 600; border-bottom: 2px solid #000; ">Paid Amount : </td>
                        <td  style="font-size: 13px; font-weight: 600; border-bottom: 2px solid #000; text-align: right;color:green !important;"><?php echo number_format($CPROW->CPayment_amount, 2); ?></td>
                    </tr>
                    <tr>
                        <td style="font-size: 13px; font-weight: 600; ">Current Due : </td>
                        <td style="font-size: 13px; font-weight: 600; text-align: right;color:red !important;"><?php echo number_format($totalDue, 2); ?></td>
                    </tr>
                </table>
            </div>
        </div>
