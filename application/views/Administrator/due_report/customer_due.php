			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr v-for="data in dues">
						...
						<td style="text-align:right ;font-size: 14px;font-weight: 600;">{{ parseFloat(data.dueAmount).toFixed(2) }}</td>
					</tr>
				</tbody>
				<tfoot>
					<tr style="font-weight:bold;">
						<td colspan="5" style="text-align:right;font-size: 14px;">Total Due</td>
						<td style="text-align:right;font-size: 16px; color: red !important;">{{ parseFloat(totalDue).toFixed(2) }}</td>
					</tr>
				</tfoot>
			</table>
		</div>
