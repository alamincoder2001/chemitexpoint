                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="text-align:right;"><span>
                                {{ payments.reduce((prev, curr) => { return prev + +curr.bill},0)  }}</span>

                        </td>
                        <td style="text-align:right;"><span>
                                {{ payments.reduce((prev, curr) => { return prev + +curr.paid},0)  }} </span>
                        </td>
                        <td style="text-align:right;"><span>
                                {{ payments.reduce((prev, curr) => { return prev + +curr.due},0)  }}</span>
                        </td>
                        <td style="text-align:right;"><span>
                                {{ payments.reduce((prev, curr) => { return prev + +curr.returned},0)  }}</span>
                        </td>

                        <td style="text-align:right;"><span>
                                {{ payments.reduce((prev, curr) => { return prev + +curr.cash_received},0)  }}</span>
                        </td>
...
new Vue({
    ...
    methods: {
        ...
        getTotalBill() {
            const result = Array.isArray(payments) ? payments.reduce((acc, curr) => acc + curr, 0) : 0;
            console.log(result);
        },
        getReport() {
